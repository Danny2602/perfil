...
import { SiDjango, SiCodeigniter, SiFlutter,SiGithub,SiGitlab,SiPostman,SiCisco,SiScrumalliance, } from "react-icons/si";
import { ReactDescription,DjangoDescription } from "@/content/descriptions";
...
const Lenguajes = [
  { icon: <FaPython />, color: "bg-[#3776AB]", Text: "Python" , description: <ReactDescription /> },
  { icon: <FaJava />, color: "bg-[#EA2D2E]", Text: "Java" , description: <ReactDescription /> },
  { icon: <FaPhp />, color: "bg-[#777BB4]", Text: "PHP" , description: <ReactDescription /> },
  { icon: <FaJs />, color: "bg-[#F7DF1E]", Text: "JavaScript" , description: <ReactDescription /> },
  { icon: <PiFileCSharpBold />, color: "bg-[#512BD4]", Text: "C#" , description: <ReactDescription /> },
];
const Frameworks = [
  ...
  { icon: <SiCodeigniter />, color: "bg-[#EE4323]", Text: "CodeIgniter" , description: <ReactDescription /> },
  { icon: <SiFlutter />, color: "bg-[#21759B]", Text: "Flutter" , description: <ReactDescription /> },
  { icon: <FaWordpress />, color: "bg-[#02569B]", Text: "WordPress" , description: <ReactDescription /> },
];
const Herramientas = [
  { icon: <PiMicrosoftExcelLogoDuotone />, color: "bg-[#217346]", Text: "Excel", description: <ReactDescription /> },
  { icon: <SiGithub />, color: "bg-[#181717]", Text: "GitHub", description: <ReactDescription /> },
  { icon: <SiGitlab />, color: "bg-[#FC6D26]", Text: "GitLab", description: <ReactDescription /> },
  { icon: <SiPostman />, color: "bg-[#FF6C37]", Text: "Postman", description: <ReactDescription /> },
  { icon: <FaTools />, color: "bg-[#5A5A5A]", Text: "Mantenimiento-Computadoras", description: <ReactDescription /> },
  { icon: <FaNetworkWired />, color: "bg-[#0078D7]", Text: "Infraestrtura-Redes", description: <ReactDescription /> },
  { icon: <SiScrumalliance />, color: "bg-[#009FDA]", Text: "Metodologías Ágiles", description: <ReactDescription /> },
];
...
function Inicio() {
    ...
    return (
        <>
            ...
            <div id="skills" className="min-h-screen  grid lg:grid-cols-3 md:grid-cols-2 sm:grid-cols-1 sm:gap-0 lg:gap-4 bg-black justify-center text-center pt-8">
                <div>
